...
public class FOVScript_VLS: MonoBehaviour {
    ...
    private void OnLightEnter(Light2D _light, GameObject _go) {
    ...
    private void OnLightStay(Light2D _light, GameObject _go) {
        ...
        if (_go.GetInstanceID() == gameObject.GetInstanceID()){
            ...
            gameObject.GetComponent<Renderer>().material.color =
                Color.Lerp(gameObject.GetComponent<Renderer>().material.color, Color.red, Time.deltaTime*0.5f);
        }
    }
